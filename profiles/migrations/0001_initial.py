    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'customer'), ('system_admin', 'System Administrator'), ('support', 'Support Staff'), ('finance', 'Finance Staff')], db_index=True, default='customer', max_length=20)),
